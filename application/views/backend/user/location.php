    ...
    <!-- fin modal-->
     ...
     $(document).ready(function(){  
               	...
               	&& idchambre != '')
                {
                  ...
                  if (date_debit > date_fin) {
	                  ...
	                  if (action =="Add") {
	                      ...
	                      $.ajax({  
	                           url:"<?php echo base_url() . 'user/operation_location'?>",  
	                           method:'POST',  
	                  ...
	                  if (action == 'Edit') {
	                        ...
	                        $.ajax({  
	                             url:"<?php echo base_url() . 'user/modification_location'?>",  
	                             method:'POST',  
	                             data:new FormData(this),  
	                             contentType:false,  
	                             processData:false,  
          ...
          $(document).on('click', '.update', function(){  
               ...
               $.ajax({  
                    url:"<?php echo base_url(); ?>user/fetch_single_location",  
                    method:"POST",  
                    data:{idl:idl},  
                    dataType:"json",  
                    success:function(data)  
              ...
              if(confirm("Are you sure you want to delete this?"))
		          {
		           		...
		           		$.ajax({
	                    url:"<?php echo base_url(); ?>user/supression_location",
	                    method:"POST",
	                    data:{
	                    	idl:idl,
	                    	idchambre: idchambre
        ...
        $("#chambre_ok").on("change", function(t) {
            ...
            if (idchambre !='') {
                $('#idchambre').val(idchambre);
	               ...
	               $.ajax({  
	                    url:"<?php echo base_url(); ?>user/fetch_single_chambre",  
	                    method:"POST",  
