                    	...
                    	<form method="post" id="user_form" enctype="multipart/form-data" class="col-md-12 row">
                    		...
                    		<div class="col-md-12">
                    			<div class="input-group flex-nowrap mb-2">
          								  ...
          								  <input type="text" name="designation" id="designation" class="form-control" placeholder="Entrez la designation de type de la chambre" />
          								</div>
                    		</div>
    ...
    <!-- fin modal-->
     ...
     $(document).ready(function(){  
          ...
          $('#add_button').click(function(){  
               $('#user_form')[0].reset();  
               $('.modal-title').text("Paramètrage des types des chambres");  
               $('#action').val("Add");  
          })  
          ...
          var dataTable = $('#user_data').DataTable({  
               ...
               "order":[],  
               "ajax":{  
                    url:"<?php echo base_url() . 'admin/fetch_type'; ?>",  
                    type:"POST"  
               },  
               "columnDefs":[  
                    {  
               ...
               if(designation != '')
                {
                  ...
                  if (action =="Add") {
                      ...
                      $.ajax({  
                           url:"<?php echo base_url() . 'admin/operation_type'?>",  
                           method:'POST',  
                  ...
                  if (action == 'Edit') {
                        ...
                        $.ajax({  
                             url:"<?php echo base_url() . 'admin/modification_type'?>",  
                             method:'POST',  
                             data:new FormData(this),  
                             contentType:false,  
                             processData:false,  
          ...
          $(document).on('click', '.update', function(){  
               ...
               $.ajax({  
                    url:"<?php echo base_url(); ?>admin/fetch_single_type",  
                    method:"POST",  
                    data:{idtype:idtype},  
                    dataType:"json",  
                    success:function(data)  
                    {  
                         ...
                         $('.modal-title').text("modification de type de la chambre "+data.designation);  
                         $('#idtype').val(idtype);   
                         $('#action').val("Edit");  
                    }  
               });  
              ...
              if(confirm("Are you sure you want to delete this?"))
		          {
		           		...
		           		$.ajax({
	                    url:"<?php echo base_url(); ?>admin/supression_type",
	                    method:"POST",
	                    data:{idtype:idtype},
	                    success:function(data)
	                    {
